  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "EducazenKids  L'enseignement sur mesure" },
      {
        ...
        content: "Maternelle & Primaire  Méthodes Montessori, Freinet, Steiner adaptées.",
      },
    ],
  }),
  component: HomePage,
...
function Hero() {
  ...
  return (
    <section
      ref={ref}
      className="relative min-h-[95vh] flex items-center overflow-hidden paper-grain"
    >
      <div className="absolute inset-0 bg-gradient-to-br from-magenta-bg via-rose to-lavender" />
      <motion.div
        style={{ x: sx, y: sy }}
        className="blob bg-magenta/40 -top-32 -right-20 w-[36rem] h-[36rem]"
      />
      <motion.div
        style={{ x: useTransform(sx, (v) => -v * 0.6), y: useTransform(sy, (v) => -v * 0.6) }}
        className="blob bg-purple/30 top-1/2 -left-32 w-[28rem] h-[28rem]"
      />
      ...
      <Doodle
        ...
        className="absolute top-32 left-[8%] w-12 h-12 animate-float-soft sticker-shadow"
      />
      <Doodle
        kind="spark"
        color="oklch(0.52 0.21 357)"
        className="absolute top-1/3 right-[8%] w-10 h-10"
        spin
      />
      <Doodle
        kind="heart"
        color="oklch(0.45 0.21 312)"
        className="absolute bottom-32 left-[15%] w-9 h-9 animate-float-soft sticker-shadow"
        delay={0.5}
      />
      <Doodle
        kind="sun"
        color="oklch(0.58 0.10 187)"
        className="absolute top-1/2 left-[5%] w-14 h-14 opacity-60"
        spin
      />
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-10 py-24 grid lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-6 z-10">
          ...
          >
            ...
            <span className="relative inline-block">
              ...
              >
                <motion.path
                  d="M3 10 Q 60 2, 120 8 T 237 10"
                  stroke="oklch(0.52 0.21 357)"
                  strokeWidth="4"
                  fill="none"
                  strokeLinecap="round"
                />
            ...
            plein de{" "}
            <span className="font-handwritten font-bold text-purple text-7xl md:text-8xl lg:text-[6.5rem]">
              réussite
            </span>
            .
          </motion.h1>
          ...
          >
            Un enseignement sur mesure pour enfants avec ou sans trouble des apprentissages.
          </motion.p>
          ...
          >
            <MagneticButton
              as="a"
              href="/contact"
              className="group inline-flex items-center gap-2 rounded-full bg-gradient-hero px-8 py-4 font-display font-bold text-white shadow-glow transition-all hover:shadow-soft"
            >
            ...
            <MagneticButton
              ...
              className="inline-flex items-center gap-2 rounded-full border-2 border-ink/15 bg-white/70 backdrop-blur px-8 py-4 font-display font-bold text-ink hover:border-magenta hover:text-magenta transition-colors"
            >
              Découvrir le centre
            </MagneticButton>
          </motion.div>
        ...
        >
          <div className="relative max-w-md mx-auto">
            <TiltCard max={8}>
              <div className="bg-white p-4 pb-16 shadow-glow rounded-sm relative">
                <div
                  ...
                  style={{ top: "-10px", left: "20px", transform: "rotate(-8deg)" }}
                />
                <div
                  className="washi-tape"
                  style={{ top: "-10px", right: "20px", transform: "rotate(8deg)" }}
                />
                <div className="relative aspect-[4/5] overflow-hidden">
                  <img
                    src={hero}
                    alt="Enfants joyeux peignant avec leurs mains"
            ...
            >
              <div className="rounded-xl bg-magenta-bg p-2.5">
            ...
            >
              ...
              <p className="text-sm text-ink font-handwritten leading-tight">
                "Mon enfant a retrouvé le goût d'apprendre."
              </p>
            </motion.div>
          </div>
        </motion.div>
    ...
    <section className="bg-white py-10 border-y border-border overflow-hidden">
      <Marquee className="mb-3">
        {words1.map((w, i) => (
          <span
            key={`a-${i}`}
            className={`font-display font-bold text-4xl md:text-6xl mx-6 ${colors[i % 4]}`}
          >
      ...
      <Marquee reverse>
        {words2.map((w, i) => (
          <span
            key={`b-${i}`}
            className={`font-handwritten font-semibold text-5xl md:text-7xl mx-6 ${colors[(i + 2) % 4]} opacity-80`}
          >
...
function StatsBand() {
  ...
  return (
    <section className="relative py-16 md:py-20 bg-canvas overflow-hidden">
      <Doodle
        kind="squiggle"
        color="oklch(0.52 0.21 357 / 0.3)"
        className="absolute top-10 left-1/4 w-32 h-6"
      />
      <Doodle
        kind="star"
        color="oklch(0.79 0.16 78 / 0.4)"
        className="absolute bottom-10 right-1/4 w-10 h-10"
      />
      <div className="mx-auto max-w-7xl px-6 lg:px-10 grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
        {stats.map((s, i) => (
          ...
          >
            <div
              className={`font-display font-bold text-5xl sm:text-6xl md:text-8xl text-${s.color} leading-none transition-transform group-hover:-rotate-3`}
            >
  ...
  const pillars = [
    {
      ...
      color: "magenta",
      title: "Inclusivité",
      desc: "la diversité est notre richesse.",
      rot: -3,
    },
    {
      icon: Heart,
      color: "purple",
      title: "Bienveillance",
      desc: "Un accompagnement cadré et chaleureux.",
      rot: 2,
    },
    {
      icon: Target,
      ...
      desc: "Plan d'Accompagnement Personnalisé (PAP) pour chaque élève.",
      rot: -2,
    },
    {
      icon: Brain,
      color: "gold",
      title: "Innovation",
      desc: "Module D.I.E.C alliant pédagogie moderne et art-thérapie.",
      rot: 3,
    },
  ];
  return (
    <section className="relative py-28 bg-warm overflow-hidden paper-grain">
      ...
      <Doodle
        kind="arrow"
        color="oklch(0.52 0.21 357 / 0.4)"
        className="absolute bottom-20 left-10 w-24 h-16"
      />
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {pillars.map((p, i) => (
            ...
            >
              <div
                className={`inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-${p.color} text-white mb-6 shadow-soft`}
              >
              ...
              <Doodle
                kind="spark"
                color={`var(--${p.color})`}
                className="absolute top-4 right-4 w-6 h-6 opacity-50"
              />
            </motion.div>
          ))}
        </div>
...
function AboutSticky() {
  const panels = [
    ...
    },
    {
      ...
      text: "Devenir le modèle au Maroc où chaque enfant est accueilli et accompagné vers son épanouissement.",
    },
    {
      image: activityArt,
      label: "Approche",
      ...
      text: "Une équipe d’experts pour un accompagnement sur mesure.",
    },
  ];
  ...
  return (
    <section className="relative bg-gradient-to-b from-white via-cream to-white overflow-hidden py-20 md:py-28">
      <Doodle
        kind="squiggle"
        color="oklch(0.45 0.21 312 / 0.25)"
        className="absolute top-10 right-[10%] w-32 h-6 hidden md:block"
      />
      <Doodle
        kind="circle"
        color="oklch(0.58 0.10 187 / 0.15)"
        className="absolute bottom-32 left-[5%] w-32 h-32 hidden md:block"
      />
      <Doodle
        kind="star"
        color="oklch(0.79 0.16 78 / 0.4)"
        className="absolute top-32 left-[8%] w-10 h-10 hidden lg:block animate-float-soft"
      />
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <motion.div {...fadeUp} className="max-w-3xl mb-12 md:mb-16">
          ...
          <h2 className="font-display font-bold text-4xl md:text-6xl lg:text-7xl leading-[1.02] tracking-tight">
            Un centre où chaque
            <br className="hidden md:block" /> enfant{" "}
            <span className="relative inline-block">
              ...
              >
                <path
                  d="M3 8 Q 60 2, 120 6 T 237 8"
                  stroke="oklch(0.45 0.21 312 / 0.5)"
                  strokeWidth="3"
                  fill="none"
                  strokeLinecap="round"
                />
          ...
          >
            {panels.map((p, i) => (
              ...
              >
                ...
                />
                <div
                  className={`absolute inset-0 bg-gradient-to-tr from-${p.color}/40 via-transparent to-${p.color}/10 mix-blend-multiply`}
                />
            ...
            >
              <p className={`font-label text-[10px] text-${current.color}`}>
                {String(active + 1).padStart(2, "0")} / 03 · {current.label}
              </p>
            </motion.div>
          </motion.div>
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-4">
                    <div
                      className={`shrink-0 mt-1 inline-flex h-10 w-10 items-center justify-center rounded-2xl font-display font-bold text-sm transition-colors ${
                    ...
                    <div className="flex-1 min-w-0">
                      <p
                        className={`font-label text-[10px] mb-2 transition-colors text-${p.color}`}
                      >
                        {p.label}
                      </p>
                      <h3
                        className={`font-display font-bold text-xl md:text-2xl leading-tight transition-colors ${
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <motion.div {...fadeUp} className="flex flex-wrap items-end justify-between gap-6 mb-16">
          <div className="max-w-2xl">
            <p className="section-num mb-4" style={{ color: "var(--teal)" }}>
              03 Nos activités
            </p>
            <h2 className="font-display font-bold text-5xl md:text-7xl leading-[1.02]">
          ...
          <Link
            to="/activites"
            className="group inline-flex items-center gap-2 font-display font-bold text-teal hover:gap-3 transition-all"
          >
          ...
          {acts.map((a) => (
            ...
            >
              ...
              <div className="absolute inset-0 p-8 flex flex-col justify-end text-white">
                <span className="font-label text-[10px] bg-white/20 backdrop-blur px-3 py-1 rounded-full self-start mb-3 opacity-0 group-hover:opacity-100 transition-opacity delay-300">
                  {a.tag}
                </span>
                <h3
                  className="font-display font-bold text-3xl lg:text-4xl leading-tight"
                  style={{ writingMode: "horizontal-tb" }}
                >
                  {a.title}
                </h3>
                <p className="font-handwritten text-xl mt-2 opacity-0 group-hover:opacity-100 transition-opacity delay-300 max-w-md">
                  {a.desc}
                </p>
              </div>
            </motion.div>
        ...
        <div className="md:hidden grid grid-cols-1 gap-5">
          {acts.map((a) => (
            <div
              key={a.title}
              className={`relative h-64 rounded-3xl overflow-hidden bg-${a.color}`}
            >
              <img
                src={a.img}
                alt={a.title}
              ...
              <div className="absolute inset-0 p-6 flex flex-col justify-end text-white">
                <span className="font-label text-[10px] bg-white/20 px-3 py-1 rounded-full self-start mb-2">
                  {a.tag}
                </span>
...
function MethodsTilt() {
  const methods = [
    {
      name: "Montessori",
      desc: "Autonomie, sensoriel, vie pratique.",
      color: "magenta",
      num: "01",
    },
          ...
          {methods.map((m, i) => (
            ...
            >
              <TiltCard className="h-full">
                <div
                  className={`bg-white rounded-3xl p-8 shadow-sticker h-full border-t-8 border-${m.color}`}
                >
  ...
  const tests = [
    {
      ...
      text: "Ma fille a retrouvé son sourire et le plaisir d'aller à l'école.",
      color: "magenta",
    },
    {
      name: "Karim O.",
      role: "Papa de Yassine, 9 ans",
      text: "L'équipe a su comprendre les besoins spécifiques de mon fils HPI.",
      color: "purple",
    },
    {
      name: "Nadia M.",
      role: "Maman de Sara, 5 ans",
      text: "Un cadre bienveillant, des pédagogues passionnés. On adore.",
      color: "teal",
    },
    {
      name: "Hicham R.",
      role: "Papa de Adam, 8 ans",
      text: "L'art-thérapie a été une révélation pour Adam.",
      color: "gold",
    },
    {
      name: "Salma K.",
      role: "Maman de Inès, 6 ans",
      text: "Inès n'a plus peur d'aller à l'école le matin. Merci !",
      color: "magenta",
    },
  ];
  return (
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10 grid lg:grid-cols-2 gap-12 items-center">
        <motion.div {...fadeUp}>
          ...
          <blockquote className="mt-6 font-handwritten text-3xl md:text-4xl text-ink leading-snug max-w-xl">
            "Depuis qu'il est ici, mon fils m'attend chaque matin avec son sac sur le dos. C'est le
            plus beau cadeau."
          </blockquote>
        ...
        <div className="relative h-[480px] overflow-hidden rounded-3xl bg-gradient-soft">
          ...
          >
            {[...tests, ...tests].map((t, i) => (
              <div
                key={i}
                className={`bg-white rounded-2xl p-6 shadow-soft border-l-4 border-${t.color} ${i % 2 === 0 ? "rotate-1" : "-rotate-1"}`}
              >
                ...
                <p className="mt-3 text-xs font-label text-ink-light">
                  {t.name} · {t.role}
                </p>
              </div>
            ))}
...
function InscriptionsCTA() {
  ...
  return (
    <section className="relative py-20 md:py-28 bg-gradient-to-br from-magenta via-magenta-light to-purple overflow-hidden">
      ...
      <Doodle
        kind="star"
        color="oklch(0.79 0.16 78 / 0.7)"
        className="absolute top-20 left-[15%] w-14 h-14 animate-float-soft"
      />
      <Doodle
        kind="spark"
      ...
      <Doodle
        ...
        className="absolute top-1/2 right-[10%] w-10 h-10 animate-float-soft"
        delay={0.4}
      />
        ...
        >
          <div className="relative max-w-md mx-auto">
            ...
            <div className="rounded-3xl overflow-hidden shadow-glow hover:rotate-0 transition-transform duration-500">
              <img
                src={poster}
                alt="Affiche inscriptions ouvertes"
                loading="lazy"
    ...
    try {
      ...
      try {
        ...
        const emailResponse = await fetch(
          `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/send-submission-email`,
          {
            method: "POST",
            headers: {
        ...
        {sent ? (
          ...
          <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-4">
            <div className="grid sm:grid-cols-2 gap-4">
              <div>
                <label className="block font-label text-[10px] text-ink-light mb-1.5">
                  Nom Du Tuteur *
                </label>
                <input
                  name="lastName"
                  required
                  type="text"
                  className="w-full rounded-xl border-2 border-canvas bg-canvas focus:bg-white focus:border-magenta px-4 py-3 outline-none transition"
                />
              </div>
              <div>
                <label className="block font-label text-[10px] text-ink-light mb-1.5">
            ...
            <div>
              <label className="block font-label text-[10px] text-ink-light mb-1.5">
                Informations à connaitre sur l'enfant
              </label>
              <textarea
                name="notes"
                rows={3}
                placeholder="Particularités, questions..."
                className="w-full rounded-xl border-2 border-canvas bg-canvas focus:bg-white focus:border-magenta px-4 py-3 outline-none transition resize-none"
              />
            </div>
            <button
              type="submit"
  ...
  const posts = [
    {
      img: blog1,
      cat: "Éducation",
      title: "5 façons d'aider votre enfant à reprendre confiance",
      date: "10 Avril 2026",
      color: "magenta",
    },
    {
      img: blog2,
      cat: "Famille",
      title: "Lire avec son enfant : un rituel qui change tout",
      date: "02 Avril 2026",
      color: "purple",
    },
    {
      img: blog3,
      cat: "Créativité",
      title: "L'art-thérapie pour les enfants atypiques",
      date: "25 Mars 2026",
      color: "teal",
    },
  ];
    ...
    <section className="py-28 bg-canvas">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <motion.div {...fadeUp} className="flex flex-wrap items-end justify-between gap-6 mb-14">
          ...
          <Link
            to="/blog"
            className="group inline-flex items-center gap-2 font-display font-bold text-magenta hover:gap-3 transition-all"
          >
            Tous les articles{" "}
            <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
          </Link>
              ...
              <TiltCard max={6}>
                <article className="group cursor-pointer">
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    <span
                      className={`font-label text-[10px] px-3 py-1 rounded-full bg-${b.color}-bg text-${b.color}`}
                    >
                      {b.cat}
                    </span>
                    <span className="text-xs font-handwritten text-ink-light text-base">
                      {b.date}
                    </span>
                  </div>
                  <h3 className="font-display font-bold text-xl leading-snug group-hover:text-magenta transition-colors">
                    {b.title}
                  </h3>
                </article>
              </TiltCard>
