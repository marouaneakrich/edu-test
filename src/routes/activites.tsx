...
const ACTIVITIES = [
  { img: montessori, title: "Pédagogie Montessori", cat: "Maternelle", age: "Tout âge", duration: "Hebdomadaire", desc: "Pédagogie du monde par la manipulation et l'autonomie. Matériel sensoriel, vie pratique, langage et mathématiques.", color: "magenta", rot: -2 },
  { img: art, title: "Art-thérapie", cat: "Bien-être", age: "Tout âge", duration: "1h30/semaine", desc: "exprimer ses émotions à travers l’art créatif", color: "purple", rot: 2 },
