  ...
  head: () => ({
    meta: [
      { title: "Activités  EducazenKids | Ateliers & Pédagogies" },
      {
        name: "description",
        content:
          "Découvrez nos activités : Montessori, Dies, Éveil sensorielle, Formation codage et IA, formation parents et bien plus.",
      },
...
const ACTIVITIES = [
  ...
  },
  {
    ...
    age: "3  8 ans",
    duration: "1h/semaine",
    desc: "Découverte des instruments, du rythme et du chant. Stimuler la sensibilité musicale et la coordination.",
    color: "teal",
    rot: -1,
  },
  {
...
const PROGRAMS = [
  {
    ...
    desc: "Cours individuels ou en petit groupe avec enseignants spécialisés.",
    color: "magenta",
  },
  {
    num: "02",
    title: "Bilan psycho-éducatif",
    desc: "Évaluation complète pour comprendre les besoins de votre enfant.",
    color: "purple",
  },
  {
    num: "03",
    title: "Atelier DYS",
    desc: "Ateliers ciblés pour dyslexie, dyscalculie, dysorthographie.",
    color: "teal",
  },
  {
    num: "04",
    title: "Coaching parental",
    desc: "Accompagnement et formation pour les parents.",
    color: "gold",
  },
  {
    num: "05",
    title: "Stages vacances",
    desc: "Stages thématiques durant les vacances scolaires.",
    color: "magenta",
  },
  {
    num: "06",
    title: "Module D.I.E.C",
    desc: "Notre approche exclusive : Développement Intégré de l'Enfant.",
    color: "purple",
  },
];
    ...
    <PageShell>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            {ACTIVITIES.map((a, i) => (
              ...
              >
                <TiltCard max={5}>
                  <article
                    className={`group rounded-3xl overflow-hidden bg-canvas shadow-sticker border-t-8 border-${a.color}`}
                  >
      ...
      <section className="relative py-24 bg-canvas overflow-hidden paper-grain">
        <Doodle
          ...
          className="absolute top-20 left-10 w-32 h-6"
        />
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <motion.div {...fadeUp} className="max-w-2xl mb-16">
            <p className="section-num mb-4" style={{ color: "var(--purple)" }}>
              02 Programmes complémentaires
            </p>
            <h2 className="font-display font-bold text-4xl md:text-6xl leading-tight">
              Au-delà des cours, un{" "}
              <span className="font-handwritten text-purple">accompagnement</span> complet.
            </h2>
          </motion.div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {PROGRAMS.map((p, i) => (
              ...
              >
                ...
                <h3 className="font-display font-bold text-xl mb-3 group-hover:text-magenta transition-colors">
                  {p.title}
                </h3>
      ...
      <section className="relative py-24 bg-gradient-soft overflow-hidden">
        <Doodle
          ...
          className="absolute top-20 left-1/4 w-12 h-12 animate-float-soft"
        />
        <Doodle
          kind="spark"
          color="oklch(0.45 0.21 312 / 0.4)"
        ...
        <motion.div {...fadeUp} className="mx-auto max-w-3xl px-6 text-center">
          ...
          <MagneticButton
            as="a"
            href="/contact"
            className="inline-flex items-center gap-2 rounded-full bg-gradient-hero px-8 py-4 font-display font-bold text-white shadow-glow hover:scale-105 transition-transform"
          >
