  ...
  return (
    <PageShell>
      <div className="font-body">
        ...
        {/* Registration Form Section - IMPROVED STYLES */}
        <motion.section {...fadeInUp} id="form-section" className="py-16 px-6 lg:px-10 bg-gradient-to-r from-ink to-purple">
          <div className="mx-auto max-w-4xl">
            ...
            <p className="text-center font-body text-white mb-10">Remplissez tous les champs pour inscrire votre enfant au camp d'été</p>
                ...
                <FormSection title="Préférences du camp">
                    ...
                    <div className="flex gap-6">
                      {[
                        ...
                        <label key={type.value} className="flex items-center gap-2 cursor-pointer">
                          ...
                          />
                          <span className="font-body text-ink-light">{type.label}</span>
                        </label>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                      {ACTIVITIES_OPTIONS.map((activity) => (
                        <label key={activity.value} className="flex items-center gap-2 cursor-pointer group p-3 rounded-xl border-2 border-border hover:border-magenta/50 transition-all">
                          <input
                            type="checkbox"
                          ...
                          />
                          <span className="font-body text-sm text-ink-light group-hover:text-magenta transition-colors">{activity.label}</span>
                        </label>
                      ))}
                    </div>
                ...
                <FormSection title="Consentements">
                  <div className="space-y-4">
                    <label className="flex items-start gap-3 cursor-pointer group">
                      ...
                      />
                      <span className="font-body text-sm text-ink-light group-hover:text-magenta transition-colors">
                    ...
                    {errors.termsAccepted && <p className="text-red-500 text-sm flex items-center gap-2 mt-2">
                      <AlertCircle className="w-4 h-4" />
...
// Form Helper Components with improved styling
